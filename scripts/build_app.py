...
native = root / 'native'
subprocess.run(common + [str(native / n) for n in ['Core.swift', 'Runtime.swift', 'Recorder.swift', 'AppSettings.swift', 'WorkerProcess.swift', 'App.swift']] + ['-framework', 'AppKit', '-framework', 'AVFoundation', '-o', str(app / 'Contents/MacOS/ZK Dictate')], check=True)
