...
final class WorkerProcess {
    ...
    func start(model: TranscriptionModel) throws {
        ...
        process.arguments = ["-I", script.path, "--parent-pid", String(ProcessInfo.processInfo.processIdentifier), "--model", model.rawValue]
